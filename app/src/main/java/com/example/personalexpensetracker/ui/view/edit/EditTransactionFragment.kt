package com.example.personalexpensetracker.ui.view.edit
...
import com.example.personalexpensetracker.databinding.FragmentEditTransactionBinding
import com.example.personalexpensetracker.model.Transaction
import com.example.personalexpensetracker.utils.Constants
import com.example.personalexpensetracker.utils.parseDouble
import com.example.personalexpensetracker.utils.snack
import com.example.personalexpensetracker.utils.transformIntoDatePicker
...
class EditTransactionFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val transactionTypeAdapter = ArrayAdapter(requireContext(), R.layout.item_autocomplete_layout, Constants.transactionType)

        val tagsAdapter = ArrayAdapter(requireContext(), R.layout.item_autocomplete_layout, Constants.transactionTags)
